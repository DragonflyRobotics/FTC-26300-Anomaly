...
@Autonomous(name = "Auto_0_5_HP")
public final class Auto_0_5_HP extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        Actions.runBlocking(
                drive.actionBuilder(beginPose, 15)
                        ...
                        .stopAndAdd(compoundActions.primitives.getElevatorDown())
                        .strafeToLinearHeading(new Vector2d(30, 48), Math.toRadians(180))
                        .strafeToLinearHeading(new Vector2d(-23, 50), Math.toRadians(135))
                        .stopAndAdd(compoundActions.primitives.getExtendoWristOut())
                        .stopAndAdd(compoundActions.getExtendIntake())
                        .waitSeconds(.25)
                        .stopAndAdd(compoundActions.getExtendIntake())
