...
public class SparkFunOTOSDrive extends MecanumDrive {
    public static class Params {
        ...
        public SparkFunOTOS.Pose2D offset = new SparkFunOTOS.Pose2D(-6.0735, -1.9104, -1.5826); //new SparkFunOTOS.Pose2D(6.0254, -0.5166, -1.582);
//-6.3618, -3.3041, 1.5611
        ...
        public double linearScalar = 48/48.53976993110236;//-24/27.1534;
        public double angularScalar = 0.9953;//0.9936;
    }
